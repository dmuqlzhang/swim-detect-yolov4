...
if __name__ == '__main__':
    ...
    detect = Detect(metaPath=r'./cfg/swim.data',
                    configPath=r'./cfg/yolov4-swim.cfg',
    ...
    ''' 读取视频，保存视频 '''
    cap = cv2.VideoCapture(r'/home/Datasets/swim1.avi')
    ...
    video_writer = cv2.VideoWriter(r'/home/Datasets/swim1.mp4', fourcc=fourcc, fps=fps, frameSize=(width,height))
